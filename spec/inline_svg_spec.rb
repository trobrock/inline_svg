  ...
  describe 'configuration' do
    ...
    context 'configuring custom transformation' do
      it 'allows a custom transformation to be added' do
        ...
        expect(InlineSvg.configuration.custom_transformations).to eq({ my_transform: { attribute: :my_transform,
      ...
      it 'rejects transformations that do not implement .create_with_value' do
        expect do
          ...
          InlineSvg::Configuration::Invalid,
          /#{MyInvalidCustomTransformKlass} should implement the .create_with_value and #transform methods/
        )
      end
      ...
      it 'rejects transformations that does not implement #transform' do
        expect do
          ...
          InlineSvg::Configuration::Invalid,
          /#{MyInvalidCustomTransformInstance} should implement the .create_with_value and #transform methods/
        )
      end
        ...
        expect do
          InlineSvg.configure do |config|
            config.add_custom_transformation(attribute: :irrelevant, transform: :not_a_class)
                           ...
                           /not_a_class should implement the .create_with_value and #transform methods/)
      end
    end
  end
end
